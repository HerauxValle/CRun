...
.DESCRIPTION
    Usage:
        ...
        .\install.ps1 -Copy        — copies the binary explicitly
        .\install.ps1 -Uninstall   — removes the installed binary
...
$BinaryName = "crun.exe"
$ReleaseBinary = Join-Path $RepoDir "target\release\$BinaryName"
